...
def imprimir_texto(texto, n, i = 1):
    for _ in range(n):
        ...
        time.sleep(i)
init(autoreset=True)
imprimir_texto(Fore.CYAN+"████████╗       ██████╗██████╗ ██╗   ██╗██████╗ ████████╗ [VERSION]:   [2.0]", 1)
imprimir_texto(Fore.CYAN+"╚══██╔══╝      ██╔════╝██╔══██╗╚██╗ ██╔╝██╔══██╗╚══██╔══╝ [CREADOR]:   [ALEJANDRO ESPINOSA]", 1)
imprimir_texto(Fore.CYAN+"   ██║   █████╗██║     ██████╔╝ ╚████╔╝ ██████╔╝   ██║    [INSTAGRAM]: https://www.instagram.com/alejandrogit9", 1)
imprimir_texto(Fore.CYAN+"   ██║   ╚════╝██║     ██╔══██╗  ╚██╔╝  ██╔═══╝    ██║    [GITHUB]:    https://github.com/Alejandrogit9", 1)
imprimir_texto(Fore.CYAN+"   ██║         ╚██████╗██║  ██║   ██║   ██║        ██║    [FACEBOOK]:  https://bit.ly/373HtNB", 1)
imprimir_texto(Fore.CYAN+"   ╚═╝          ╚═════╝╚═╝  ╚═╝   ╚═╝   ╚═╝        ╚═╝ => [FOR LINUX] <=", 1) 
